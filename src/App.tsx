    ...
    <div className="flex flex-col min-h-screen bg-slate-50">
      ...
      <header className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-slate-200">
        ...
        <div className="md:hidden flex items-center justify-between px-6 py-4 border-b border-slate-100">
          ...
          <button
            onClick={() => setLocation('/implementation')}
            className="inline-flex items-center justify-center rounded-full bg-slate-900 px-4 py-2 text-xs font-semibold text-white shadow-sm"
          >
            Proposal
          </button>
        </div>
          ...
          <div className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
            ...
            <div className="mt-16 border-t border-slate-800 flex flex-col md:flex-row items-center justify-between gap-6 pt-8 text-sm text-slate-500 font-medium">
              <div className="flex items-center gap-3">
                ...
                Prepared for Advanced Health &amp; Skin Clinic by Evoque Consulting
              </div>
